...
export default class HomePage extends Component {
  ...
  componentDidMount() {
    ...
    if(login_code !== undefined) {
      ...
      const server_login_url = "https://dailyfood.herokuapp.com/login";
      const headers = {
      ...
      .then(response => {
        ...
        this.setState({
          ...
          const get_admins_url = "https://dailyfood.herokuapp.com/admins";
  ...
  handleLoginClicked = () => {
    ...
    const channelId = "1560672959";
    const redirectUri = "https://nogerm.github.io/dailyfood";
    const state = "access";
    const nonce = "54321";
    const maxAge = 30 * 60;
        ...
        <Grid.Row columns={1} style={{padding: '0px'}}>
          <Segment raised style={{background: '#37474f', margin: '0px', flex:1}}>
            <div style={{flexDirection: 'row', display: 'flex' }}>
              ...
              <Header as='h1' style={{color:'white', margin:'0px', padding:'8px', flex:1, fontFamily: 'Roboto'}}>活力小幫手 設定介面</Header>
